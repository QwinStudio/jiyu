(()=>{
  ...
  const attach=mode=>{
    ...
    controls.innerHTML='<button type="button" class="lyrics-prev" aria-label="Previous">&#9198;</button><button type="button" class="lyrics-play" aria-label="Play">&#9654;</button><button type="button" class="lyrics-next" aria-label="Next">&#9197;</button>';
    header.append(controls);
    const play=controls.querySelector('.lyrics-play');
    const sync=()=>{play.innerHTML=audio.paused?'&#9654;':'&#10074;&#10074;'};
